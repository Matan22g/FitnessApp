...
.. code-block:: python
    ...
    from kivymd.uix.menu import customMDDropdownMenu
    ...
    class Test(MDApp):
        def __init__(self, **kwargs):
            ...
            self.menu = customMDDropdownMenu(
...
.. Warning:: Do not create the :class:`~customMDDropdownMenu` object when you open
...
.. code-block:: python
    ...
    menu = customMDDropdownMenu(caller=self.screen.ids.button, items=menu_items)
    menu.open()
...
.. code-block:: python
    ...
    from kivymd.app import MDApp
    from kivymd.uix.menu import customMDDropdownMenu, RightContent
...
.. code-block:: python
    ...
    class CustomDrop(customMDDropdownMenu):
    ...
    class Test(MDApp):
        ...
        def check_item(self, menu, item):
            if item.text == "Open submenu" and not self.submenu:
                menu_items = [{"text": f"Item {i}"} for i in range(5)]
                self.submenu = customMDDropdownMenu(
                    caller=item,
                    items=menu_items,
                    width_mult=4,
                    selected_color=self.theme_cls.bg_darkest,
...
.. Warning:: The :class:`~customMDDropdownMenu` does not work with the standard
...
.. code-block:: python
    ...
    class Test(MDApp):
        ...
        def create_menu(self, text, instance):
            ...
            menu = customMDDropdownMenu(caller=instance, items=menu_items, width_mult=5)
...
.. seealso::
    ...
    :attr:`~customMDDropdownMenu.position`
...
__all__ = ("customMDDropdownMenu", "RightContent")
...
class MDMenu(ScrollView):
    ...
    """
    See :attr:`~customMDDropdownMenu.width_mult`.
    """

    drop_cls = ObjectProperty()
    """
    See :class:`~customMDDropdownMenu` class.
    """


class customMDDropdownMenu(ThemableBehavior, FloatLayout):
    """
    :Events:
        :attr:`on_enter`
