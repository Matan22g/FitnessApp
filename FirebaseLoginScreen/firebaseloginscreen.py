...
class FirebaseLoginScreen(Screen, EventDispatcher):
    ...
    def successful_sign_up(self, urlrequest, log_in_data):
        ...
        post_request = UrlRequest("https://gymbuddy2.firebaseio.com/" + log_in_data['localId'] + ".json?auth=" + log_in_data['idToken'], ca_file=certifi.where(),
    ...
    def successful_reset(self, urlrequest, reset_data):
        ...
        self.app.dialog = MDDialog(text="Reset password instructions sent to your email.", radius=[10, 7, 10, 7], size_hint=(0.5,None))
        self.app.dialog.open()
